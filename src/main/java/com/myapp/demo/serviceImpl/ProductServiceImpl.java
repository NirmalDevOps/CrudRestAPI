package com.myapp.demo.serviceImpl;
    ...
    public ProductResponseDTO updateProduct(long productId,ProductRequestDTO productRequestDTO){
        ...
        try {
            ...
            if (existingProduct.isPresent()) {
                ...
                productResponseDTO = ValueMapper.convertToDTO(updatedProduct);
            }
            return productResponseDTO;
        }
        catch (Exception ex){
            log.error("Unable to load the product for the Id {} ",productId);
            throw  new ProductNotFoundException("Product Id not found "+productId);
        }
    }

    public ProductResponseDTO updateProductFields(long productId, Map<String,Object>fields){
